...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['search'])) {
    ...
    // Database query
    $query = "SELECT * FROM instructor WHERE instructorName LIKE ? AND semester = ?";
    $stmt = $conn->prepare($query);
    $instructorNameLike = "%" . $instructorName . "%";
    $stmt->bind_param("ss", $instructorNameLike, $semester);
    $stmt->execute();
    ...
    if (!empty($rows)) {
        ...
        $message = 'No instructors found with the provided name and semester.';
    }
}
?>
    ...
    <form method="POST" action="">
        <div class="search-box">
            <div class="form-value">
                <h1 style="font-weight:600;">Instructor Name</h1>
                <div class="inputbox">
                    <ion-icon name="search"></ion-icon>
                    <input type="search" name="instructorName" placeholder="Enter Instructor Name" required/>
                </div>
                <div class="inputbox">
