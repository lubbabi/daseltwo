...
<head>
  ...
  <link rel="stylesheet" href="oras.css">
  ...
  <div class="home-page">
    ...
    <div class="frame-container">
      <div class="content-center">
        <div class="title">Detach The Delays</div>
...
s60.2,40,120,40s59.8,0,59.8,0l0.2,143H-60V96L-40,95.6z"></path>
    ...
    <div class="div-title">
      <div class="dominate-your-day">
        “Dominate your day with TIME, the ultimate scheduling system from the Institute of Computer Studies, designed for effortless productivity.”
      </div>
    </div>
    ...
    <div class="container">
      <div class="side-by-side">
        <div class="left-section">
          <img class="calendar-icon" src="calendariconvectorscheduledate600nw1725960022--1-removebgpreview-1@2x.png" alt="Calendar Icon">
        </div>
    ...
    <div class="container2">
      <div class="side-by-side inverted">
        <div class="left-section">
          <div class="picture-two">
            <!-- Background box with image -->
          </div>
          <div class="title-box">
            <h2>ROOM NUMBER OR SECTION SCHEDULES</h2>
          </div>
        </div>

        <div class="right-section">
          <img class="search-icon" src="pkjmiiblacksearchbuttoncliparthd-1@2x.png" alt="Search Icon">
        </div>
      </div>
    </div>
